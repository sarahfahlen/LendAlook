...
{
    public static tøj test1 = new tøj { id = 1, type = "bluse", størrelse = "small", beskrivelse = "efe", farve = "blå", ejer = rip};
    public static tøj test2 = new tøj { id = 2, type = "bukser", størrelse = "medium", beskrivelse = "rth", farve = "sort", ejer = rap};
